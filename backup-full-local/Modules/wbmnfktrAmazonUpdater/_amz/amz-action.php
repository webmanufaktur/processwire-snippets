...
foreach($ps as $p) {
    ...
    if ($response === FALSE) {
        ...
        echo $asin . " - " . "Request failed.\n" . "<br>";
        // wenn keine Rückmeldung, Datensatz markieren
        $product = $pages->get("amz_asin=$asin");
        $product->of(false);
        ...
        if ($pxml === FALSE) {
            ...
            // $largeimage = $pxml->Items->Item->ImageSets->ImageSet->LargeImage->URL;
    
    
            if($product->amz_check) {
                ...
                $product->save();
                echo $product->amz_asin . " - " . "aktualisiert (kleine Abfrage).\n" . "<br>";
                ...
                echo $product->amz_asin . " - " . "aktualisiert (Initialabfrage).\n" . "<br>";
